      ...
      <div className="relative bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
        ...
        <div className="flex items-start justify-between px-6 pt-5 pb-4 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-semibold text-[var(--color-dark-slate-gray)] leading-tight">Delete CV</h2>
        ...
        <div className="px-6 py-5">
          <div className="flex gap-3 p-3.5 rounded-xl border border-[var(--color-soft-coral)]/20"
            ...
            <p className="text-sm text-[var(--color-cool-gray)] leading-relaxed">
              This CV will be permanently removed. This action cannot be undone.
            </p>
          </div>
        </div>
