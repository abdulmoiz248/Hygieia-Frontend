  ...
  return (
    <footer id="contact" className="w-full bg-dark-slate-gray text-white">
      ...
      <div className="wave-top h-12 w-full overflow-hidden">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="h-full w-full fill-snow-white">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <img alt='logo' src='/logo/logo-2.png' className="h-12 w-12 rounded-full bg-transparent"></img>
      ...
      <Dialog open={showPrivacyModal} onOpenChange={setShowPrivacyModal}>
        <DialogContent className="max-w-3xl bg-white max-h-[80vh] overflow-y-auto">
          ...
          <div className="mt-4 space-y-4">
            ...
            <p>Hey there! Welcome to Hygieia's Privacy Policy. We're all about keeping your data safe and transparent. This policy breaks down exactly what we collect, how we use it, and how we guard it—no filler, no BS.</p>

            <h3 className="text-lg font-semibold">2. Information We Collect</h3>
            <p>When you vibe with our platform—signing up, chatting with a doctor, or subscribing to our newsletter—we might grab stuff like:</p>
            ...
            <p>Here's the deal: we use your info to power up Hygieia. That means:</p>
            <ul className="list-disc list-inside space-y-1">
            ...
            <p>We treat your personal info like a diamond. We've got SSL encryption, secure servers, and best-practice protocols to block unauthorized access, leaks, or tweaks. If stuff ever goes sideways, we'll let you know ASAP.</p>

            <h3 className="text-lg font-semibold">5. Your Rights</h3>
            <p>You're the boss of your data. You can:</p>
            <ul className="list-disc list-inside space-y-1">
            ...
            <p>Got questions, concerns, or just wanna rant about privacy? Hit us up at <a href="mailto:privacy@hygieia.com" className="text-softCoral">privacy@hygieia.com</a>. We'll get back to you within 48 hours.</p>
          </div>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={showTermsModal} onOpenChange={setShowTermsModal}>
        <DialogContent className="max-w-3xl max-h-[80vh] bg-white overflow-y-auto">
          ...
          <div className="mt-4 space-y-4">
            ...
            <p>By hopping onto Hygieia—whether you're booking a doc, chatting in our app, or just browsing—you're down with these Terms of Service. No exceptions.</p>

            <h3 className="text-lg font-semibold">2. Use of Services</h3>
            <p>You'll use our platform only for legit, lawful stuff. Don't go wild with anything shady or sketchy—keep it clean.</p>

            <h3 className="text-lg font-semibold">3. User Accounts</h3>
            <p>Your account creds? Your biz. Keep them locked down. Anything that happens under your login is on you—so don't share that password.</p>

            <h3 className="text-lg font-semibold">4. Intellectual Property</h3>
            <p>All the content, code, logos, and magic behind Hygieia belong to us. Don't copy, remix, or resell without our explicit permission—you'll be stepping on copyright and trademark laws.</p>

            <h3 className="text-lg font-semibold">5. Limitation of Liability</h3>
            <p>We built Hygieia with love, but we can't cover every single glitch or freak accident. We're not on the hook for any indirect, special, or punitive damages—use at your own risk.</p>

            <h3 className="text-lg font-semibold">6. Changes to Terms</h3>
            <p>We might tweak these Terms from time to time. When we do, we'll post the update here. If you keep using Hygieia after a change—congrats, you just accepted it.</p>

            <h3 className="text-lg font-semibold">7. Termination</h3>
            <p>If you break the rules or just act out, we reserve the right to suspend or terminate your account without warning. No hard feelings—but we gotta keep the community safe.</p>
          </div>
        </DialogContent>
      </Dialog>
    </footer>
