          ...
          {value?.map((h) => (
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Select value={h.start} onValueChange={(v) => updateTime(h.day, "start", v)} disabled={disabled}>
                ...
                <Select value={h.end} onValueChange={(v) => updateTime(h.day, "end", v)} disabled={disabled}>
                  <SelectTrigger className="w-28">
        ...
        {!disabled && value?.length > 1 && uniqueLocations.length > 0 && (
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-500">
              Click a location to apply it to all working days:
            </p>
            <div className="flex flex-wrap gap-2">
