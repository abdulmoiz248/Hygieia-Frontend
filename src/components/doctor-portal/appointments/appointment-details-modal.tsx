...
import { Clock, MapPin, Mail, Calendar, FileText, User, Activity } from "lucide-react"
import { useDoctorAppointmentStore } from "@/store/doctor/doctor-appointment-store"

export function AppointmentDetailsModal() {
  const { selectedAppointment, setSelectedAppointment } = useDoctorAppointmentStore()
        ...
        <div className="space-y-6">
          ...
          {appointment.patient && (
            <>
              ...
              <div>
                <h3 className="font-semibold mb-3 flex items-center">
                  <Activity className="h-4 w-4 mr-2" style={{ color: "var(--color-soft-coral)" }} />
                  Patient Medical Information
                </h3>
                <div className="bg-muted/50 p-4 rounded-lg space-y-3">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{appointment.patient.bloodType || "N/A"}</p>
                    </div>
                    <div>
