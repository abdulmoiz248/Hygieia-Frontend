...
import ReportModal from "@/components/patient dashboard/appointments/ReportModal"
import type { ReportProviderRole } from "@/hooks/patient/useProviderReport"
...
export default function AppointmentsPage() {
  ...
  const handleDownloadAppointmentSchedulePdf = async () => {
    try {
      ...
      const drawFooter = (doc: any, pageNumber: number, pageCount: number) => {
        ...
        doc.setFontSize(9)
        doc.text(`Page ${pageNumber} of ${pageCount}`, pageWidth / 2, pageHeight - 16, {
          align: "center",
        })
      }
  ...
  const getProviderRole = (appointment: Appointment): ReportProviderRole => {
    ...
    return doc?.role === "nutritionist" ? "nutritionist" : "doctor"
  }
  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
            ...
            <>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-lg">
                  ...
                  {selectedAppointment.mode === AppointmentMode.Physical &&
                  ...
                  {selectedAppointment.mode === AppointmentMode.Online &&
                ...
                <div className="flex gap-3 pt-4 border-t flex-wrap">
                  {selectedAppointment.status === AppointmentStatus.Upcoming && (
                    <>
                      <Button
                        onClick={() => {
                  ...
                  {selectedAppointment.status === AppointmentStatus.Completed && (
                    <>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          setSelectedAppointment(null)
                          setReportTarget(selectedAppointment)
                        }}
      ...
      {/* Report Modal — rendered once, driven by reportTarget */}
      {reportTarget && (
  <ReportModal
    open={!!reportTarget}
    ...
    patientId={patientId}
    provider={{
      id: reportTarget.doctorId,              // ← Supabase UUID
      name: reportTarget.doctor.name,
      img: reportTarget.doctor.img,
      role: getProviderRole(reportTarget),
      specialization: (reportTarget.doctor as any).specialization
    }}
  />
)}
    </motion.div>
