...
import Suggestions from "@/components/doctor-portal/profile/Suggestions"
...
import useDoctorStore, { DoctorProfile } from "@/store/doctor/doctor-store"
import WorkingHours from "@/components/doctor-portal/profile/WorkingHours"
import DoctorCard from "@/components/doctor-portal/profile/DoctorCard"
import { uploadUserAvatar } from "@/helpers/UploadProfilePic"
import { generateBio } from "@/components/doctor-portal/profile/GenerateBio"
...
export default function DoctorProfilePage() {
  const { profile: reduxProfile, updateProfileField } = useDoctorStore()
  const saveProfile = useDoctorStore().setProfile

  const [isEditing, setIsEditing] = useState(false)
  const [profile, setProfile] = useState<DoctorProfile>(reduxProfile!)
    ...
    <>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex justify-between items-center">
          <div>
            ...
            <p className="text-cool-gray">Manage your personal and professional information</p>
          </div>
          ...
          {isEditing ? (
            ...
            <Button onClick={() => setIsEditing(true)} className="bg-soft-blue hover:bg-soft-blue/90">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <DoctorCard
            ...
            onAvatarChange={(file) =>
              uploadUserAvatar<DoctorProfile>(
                file,
                "doctor",
                profile.id,
                updateProfileField
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setProfile((prev) => ({ ...prev, experienceYears: Number(e.target.value) }))
                      }
                      disabled={!isEditing}
                      placeholder="e.g. 10"
                    />
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Textarea
                      ...
                      disabled={!isEditing}
                      placeholder="e.g. MBBS, FCPS, Board Certified"
                      rows={2}
                    />
                    {isEditing && (
                      <Suggestions
                        items={["MBBS", "FCPS", "MD", "Board Certified", "Fellowship"]}
                        onSelect={(item) =>
                          setProfile((prev) => ({
                            ...prev,
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Textarea
                      ...
                      disabled={!isEditing}
                      placeholder="e.g. MBBS King Edward Medical University, FCPS Cardiology"
                      rows={2}
                    />
                    {isEditing && (
                      <Suggestions
                        items={["MBBS", "MD", "FCPS", "Fellowship", "Residency"]}
                        onSelect={(item) =>
                          setProfile((prev) => ({
                            ...prev,
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setProfile((prev) => ({ ...prev, consultationFee: Number(e.target.value) }))
                      }
                      disabled={!isEditing}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-700 mt-1">
                        Your specialization, certifications, and availability help patients find the right doctor for their needs.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <Dialog open={isDiscardModalOpen} onOpenChange={setIsDiscardModalOpen}>
        <DialogContent className="bg-snow-white">
          ...
          <DialogFooter>
            <Button type="button" variant="outline" onClick={() => setIsDiscardModalOpen(false)}>
              Keep Editing
            </Button>
            <Button
              type="button"
